//Developer: Mubashir Zulfiqar  Date: 3/5/2021  Time: 2:17 AM
//Happy Coding...
...
public class Command_NowPlaying implements Commands_Interface {
    @Override
    public SearchListResponse handle(Commands_Context context) throws IOException {
        ...
        embedBuilder.setAuthor("Now Playing " + trackInfo.title +
                " by " + trackInfo.author +
                " (Link: <" +
                trackInfo.uri + ">)");
